...
uint256 hashGenesisBlock("0xb54e09b37c7053a803f17cefb52c31e56374e8260323f8a42dcf831de0eef4c6");
...
const string strMessageMagic = "PoneCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight < 17280) // 25 PONE reward within the first 3 days
        nSubsidy = 25 * COIN;
    if(nHeight > 10519200) // half block reward after 5 years
        nSubsidy = (50 * COIN) / 2;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 1 * 60 * 60; // PoneCoin: 1 hour
static const int64 nTargetSpacing = 120; // PoneCoin: 2 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // Pone difficulty adjustment protocol switch
    ...
    // Ponecoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ponecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PoneCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x649e49f97142b3368b8472832d09bf097ad1dd012dd95b1717c645cabeae44eb");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Twilight Sparkle: I MUST FINISH THIS COIN BY SUNDOWN OF 12/24/14!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1419457568;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 388065852;

        if (fTestNet)
        {
            block.nTime    = 1419452264;
        ...
        assert(block.hashMerkleRoot == uint256("0x92b13055b4c0bf2c3548db34e55ef78016267151f267b3850295abee2840c591"));
